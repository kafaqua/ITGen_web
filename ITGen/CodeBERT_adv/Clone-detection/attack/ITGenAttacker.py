...
import os
sys.path.append('../../../')
sys.path.insert(0, '../../../')  # Add project root to beginning of path
import importlib.util
spec = importlib.util.spec_from_file_location("utils", "../../../utils.py")
utils_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(utils_module)
CodeDataset = utils_module.CodeDataset
get_identifier_posistions_from_code = utils_module.get_identifier_posistions_from_code
is_valid_identifier = utils_module.is_valid_identifier
get_code_tokens = utils_module.get_code_tokens
_tokenize = utils_module._tokenize
get_masked_code_by_position = utils_module.get_masked_code_by_position
