...
from utils import CodeDataset, get_identifier_posistions_from_code, is_valid_identifier, get_code_tokens
from run_parser import get_identifiers, get_gen_code, get_example_batch
...
class Bayes_Attacker(object):
    ...
    def get_initial_block_order(self, inds_list):
        ...
        for inds in inds_list:
            ...
            for i in range(start,end+1):
                if del_code[i] in self.identifiers:
                    del_code[i] = '<unk>'
    ...
    def bayes_attack(self, example, substitutes, code, query_times, logits, example_start_time):
        ...
        self.identifiers = deepcopy(variable_names)
        ...
        while self.BLOCK_QUEUE:
            ...
            if stage_call == -1:
                ...
                if is_success == 1:
                    ...
                    return self.adv_code(code_1, new_code_tokens), 0, self.replaced_words(self.code_tokens_1, new_code_tokens)
